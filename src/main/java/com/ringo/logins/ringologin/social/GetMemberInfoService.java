...
import com.ringo.logins.ringologin.common.TokenDecoder;
...
public AppleIdTokenPayload get(String authorizationCode){
    ...
    private String generateClientSecret(){
        ...
        return Jwts.builder()
                ...
                .setIssuer(appleProperties.getAudience())
    ...
    private PrivateKey getPrivateKey(){
        ...
        try{
            ...
            throw new RuntimeException("Error convering private key from String",e);
        }
    }
